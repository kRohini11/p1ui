...
export const Pagination = ({ currPage, setCurrPage, totalPages }) => {
    ...
    return <div className="row">
        ...
        <div className="col-4 text-center">
            <button className="btn btn-danger" onClick={fnPrev} disabled={currPage == 1}>Prev</button >{currPage}<button className="btn btn-danger"  onClick={fnNext} disabled={currPage == totalPages}>Next</button>
        </div>
